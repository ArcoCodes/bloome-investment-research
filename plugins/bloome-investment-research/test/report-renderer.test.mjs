...
test("React SSR compiles Markdown into self-contained report HTML", async () => {
  ...
  await Promise.all([
    ...
    writeFile(path.join(workspace, "evidence.json"), JSON.stringify([
      { chunk_id:"s1",title:"NAND Market Outlook",title_zh:"NAND市场展望",page_start:3,published_at:"2026-08-01",quote:"Demand is improving while qualification remains uncertain.",quote_zh:"需求正在改善，但验证仍存在不确定性。<u>非标注</u>" },
      { chunk_id:"s2",title:"Channel Check",title_zh:"渠道调研",published_at:"2026-08-01",quote:"Channel demand improved." },
    ])),
  ...
  assert.match(html, /〔NAND市场展望, p\.3〕/);
