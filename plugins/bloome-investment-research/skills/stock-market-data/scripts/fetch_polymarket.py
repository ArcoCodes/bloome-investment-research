...
# ///
# Adapted from TauricResearch/TradingAgents (Apache-2.0) dataflows/polymarket.py
...
if __name__ == "__main__":
    ...
    p = argparse.ArgumentParser(description="Polymarket prediction markets by topic (keyless)")
    p.add_argument("topic"); p.add_argument("--limit", type=int, default=10)
    a = p.parse_args()
    print(_json.dumps({"topic": a.topic, "source": "polymarket",
                       "data": get_prediction_markets(a.topic, limit=a.limit)}, ensure_ascii=False))
